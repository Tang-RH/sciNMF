...
#' @param top Number of top genes to be considered.
#' @param min.size.MP Minimum number of genes contained in a MetaProgram (MP), the MP without enough unique genes will be removed.
#' @param key A prefix to be added to the names of generated MPs.
#' @param only.gene Logical, indicating whether to include only genes or both genes and their coefficients.
#' @param keep.rep.gene Logical, indicating whether to keep redundant genes.
