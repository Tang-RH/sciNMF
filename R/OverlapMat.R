...
#' @param Jaccard A logical value indicating whether to calculate Jaccard similarity. If \code{TRUE}, the function calculates the Jaccard similarity between the gene sets; otherwise, it calculates the number of the intersection.
#'
#' @details
...
#' @export
#'
OverlapMat <- function(ls1, ls2 = ls1, Jaccard = FALSE){
  mat = sapply(ls1,function(m1){
    sapply(ls2,function(m2){
