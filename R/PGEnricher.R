#' Program Enricher
#'
#' Performing universal enrichment analysis on transcriptome programs (gene sets)
#'
#' @param pg.list A list containing transcriptome programs, each program is composed with genes.
...
#'
#' @return A list containing the enrichment results for each input transcriptome program.
#' Each element of the list represents one transcriptome program and contains a data.frame with enrichment results.
#'
#' @details
