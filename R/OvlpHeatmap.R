...
#'
#' @param mat.ovlp A square matrix generated by \code{\link{OverlapMat}}, representing the overlap scores between gene sets.
...
#' # cluster the programs by intersection between every pair of programs
#' hm1 <- OvlpHeatmap(ovlp1, cut.num = 3, max.intersect = 20)
#' print(hm1)
#'
...
#' @export
OvlpHeatmap = function(mat.ovlp, cut.num = NA, border="grey",
    ...
    hm = ComplexHeatmap::pheatmap(mat.ovlp, border=border, name = name,
