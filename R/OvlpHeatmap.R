...
OvlpHeatmap = function(ovlp, cut.num = NA, border="grey",
                       ...
                       name = 'Share Genes', show.colnames = FALSE,
                       breaks = c(0:25), color = c('white',rev(as.character(paletteer::paletteer_c("viridis::magma", 32))[8:32])),...){
    ...
    if(!is.na(cut.num)){
        ...
        anno_color = as.character(paletteer_d("ggsci::default_igv"))[1:max(cluster)]
